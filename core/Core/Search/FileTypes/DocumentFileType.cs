...
namespace Regensburger.RShare
{
    ...
    public class DocumentFileType : FileType
    {
        ...
        {
            FileExtentions = new string[] { ".chm", ".css", ".diz", ".doc", ".dot", ".hlp", ".htm", ".html", ".nfo", ".pdf", ".pps", ".ppt", ".ps", ".rtf", ".txt", ".wri", ".xls", ".xml"};
        }
        ...
        public override string ToString()
        {
            ...
            switch (Settings.Instance["UICulture"])
            {
                ...
                case "it":
                    fileTypeString = "Documenti";
                    break;

                case "tr":
                    fileTypeString = "Belge";
                    break;
