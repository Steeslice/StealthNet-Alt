...
{
    internal sealed class Command13
        : Command
    {
        ...
        public Command13(RijndaelParameters keys)
        {
            m_Keys = keys;
            m_Command = new CommandBuilder(CommandBuilder.EncryptionMethod.RSA, 0x13);
            m_Command.Write((byte)0x13);
        ...
        public Command13(CommandBuilder command)
        {
            if (command == null)
