...
{
    internal sealed class Command46
        : Command, IResponseCommand
    {
        ...
        private byte[] m_SectorHashCodeResult;
        ...
        public byte[] SectorHashCodeResult
        {
            get
            {
                return m_SectorHashCodeResult;
            }
        }
        ...
        public Command46(CommandBuilder command)
        {
            if (command == null)
