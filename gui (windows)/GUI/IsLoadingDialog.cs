...
{
    internal sealed partial class IsLoadingDialog
        : Form
    {
        public IsLoadingDialog()
        {
        ...
        private void IsLoadingDialog_Paint(object sender, PaintEventArgs e)
        {
            ...
            gr.DrawString(String.Format(RShare.Properties.Resources.StealthNetIsLoading,Core.Version), font, Brushes.AntiqueWhite, new RectangleF(new PointF(16F, 302F), new SizeF(489F, 37F)), sf);
            sf.Dispose();
            font.Dispose();
        }
